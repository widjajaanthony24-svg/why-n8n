...
### **[Add it from the Chrome Web Store →](https://chromewebstore.google.com/detail/fohlnphfoamfpkbbbaaebfpgiponngag)**

One click. Then open n8n, go to **Executions**, and click the toolbar icon.
Nothing to sign up for and nothing to configure.

Prefer not to use the store? The [latest release](https://github.com/widjajaanthony24-svg/why-n8n/releases/latest)
is the same build: unzip it, open `chrome://extensions`, turn on **Developer
mode**, then **Load unpacked** and pick the folder.
